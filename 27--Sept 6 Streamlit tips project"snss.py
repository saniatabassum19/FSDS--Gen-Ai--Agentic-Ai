...
st.write("This app displays a variety of Seaborn plots created by Sania Tabassum exploring the Tips dataset, which includes data on restaurant bills and tips.")
